                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min &euro; 100</a> </li>
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>Total Amount</p>
                                        <h3 class="value"><strong>&euro;<?php echo $item_total; ?></strong></h3>
                                        <p>Free Shipping</p>
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >&euro;<?php echo $product['price']; ?></span>
