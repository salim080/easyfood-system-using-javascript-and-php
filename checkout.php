												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                                                        ...
                                                        if($order){
                                                            ...
                                                            $mail->Body    =  "<b>Your Order!</b><br>
                                                            ITEM: <b> {$name} </b><br>
                                                            Price: <b> {$price} </b><br>
                                                            QUANTITY: <b> {$qty} </b><br>
                                    <hr> <center>Total Cost</center>
                                                             Cart Subtotal: <b> {$item_total} </b><br>
                                                             Shipping Handling: <b> FREE</b><br>
                                                             TOTAL: <b> {$item_total} </b>
                                                            ";
                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Cart Subtotal</td>
                                                        <td> &euro;<?php echo $item_total; ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> &euro;<?php echo $item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
